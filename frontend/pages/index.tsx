...
export default function IndexPage({ initialData, baseUrl }: PageProps) {
    return (
        <>
            <SeoHead
                title='Poemunity'
                description='Discover, read and share poems. Browse by genre, explore famous and community poets, and publish your own work.'
                url={baseUrl}
            />
...
export const getServerSideProps: GetServerSideProps = async ({ req }) => {
    ...
    const data = await serverFetch<InitialPoemsData>('/api/v1/poems', { page: 1, limit: 10 }, token)
